// pages/pay/orderScreening/orderScreening.js
var app = getApp();
Page({
    ...
    search: function (e) {
        ...
        wx.request({
            ...
            data: {
                ...
                startWxDate: this.data.timeStartStamp,
                endWxDate: this.data.timeEndStamp
            },
            success: e => {
                wx.hideLoading();
                if (e.data.code == 200) {
                    //查询成功
                    var payData = e.data.parameter;//payData肯能为null
                    if(payData == null) {
                        payData = [];
                    }
                    var payDataLength = payData.length;
                    var collectMoney = 0;
                    var payMoney = 0;
                    ...
                    //转跳
                    wx.navigateTo({
                        url: '../screeningResult/screeningResult'
                    });
